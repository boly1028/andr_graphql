...
export class AndrHttpApiStack extends cdk.Stack {
  constructor(
    ...
    const titleServiceEndpoint = httpApiEndpoint + "/api/title";
    const authServiceEndpoint = httpApiEndpoint + "/api/auth";

    new cdk.CfnOutput(this, "HTTP API endpoint: ", {
      value: httpApiEndpoint,
    });
    new cdk.CfnOutput(this, "Title Service: ", {
      value: titleServiceEndpoint,
    });
    new cdk.CfnOutput(this, "Auth Service: ", {
      value: authServiceEndpoint,
    });
  }
}
